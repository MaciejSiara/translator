package com.translator.translate.data.translate

import com.example.translator.NetworkConstants
...
class KtorTranslateClient(
    ...
    override suspend fun translate(
                ...
                httpClient.post {
                    ...
                    setBody(
                        TranslateDto(
                            ...
                            targetLanguageCode = fromLanguage.langCode
                        )
                    )
                }
        } catch (e: IOException){
        ...
        return try {result.body<TranslatedDto>().translatedText}catch(e: Exception){
